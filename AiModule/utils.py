...
class Util:
    ...
    def tax_calculation(self,net_amount:float,percent_of:int=1)->float:
        gst_amount= self.big_float_multipilcaiton([net_amount],[percent_of])
        gst_amount/=100
        return gst_amount
    
    def tax_included_amount(self,amount:float,percent_of:int=1)->float:
        return amount+self.gst_calculation(net_amount=amount ,percent_of=percent_of)
